...
<?php 
        ...
        $query_date = "Select *, customer.Name, customer.contactNum from service_commissions left join customer on customer.customer_id = service_commissions.cust_id where service_commissions.cust_id = $job_listing_id;";
        ...
        while($row = mysqli_fetch_array($query_run_date)){
          ...
          $customer_contactNum = $row['contactNum'];
    ...
    <br>
      ...
      <div class="form-group">
        ...
        <input style="background:white;border-radius: 10px;border-color: none; border-style: none;font-size: 14px" class="form-control" type="text" value="<?php echo $job_order_date;?>" placeholder="mmmm" id="date_serviced" name="date_serviced" readonly>
        </div>
      </div>
        ...
        <label style="color: #868686;font-size: 12px;" for="discounts">Additional Charges</label>
         <select onchange="pop_up_additionals()" name="additionals" id="additionals" style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px" class="form-control">
            <?php 
                ...
                if(strcmp($additional_charges, "none")){
                   ?>
                    <option value="<?php echo "none";?>" selected>
                        <?php echo "None";?>
                    </option>
                   ...
                   <?php
                }else if(strcmp($additional_charges, "others")){
                   ?>
                  <option value="<?php echo "none";?>">
                      <?php echo "None";?>
                  </option>
            
                  <option value="<?php echo "others";?>" selected>
                      <?php echo "Others";?>
                  </option>
                   <?php
                }
    ...
    <div class="form-group">
        <div style="display:block;border: 1px solid #D3D3D3;padding-bottom: 1%;padding-top: 1%;padding-right: 2%;padding-left: 2%;border-radius: 15px;">
         <textarea style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px;width: 100%;" id="note" name="note" placeholder="Note here" class="form-control"><?php echo $others_note;?></textarea>
        </div>
    </div>
    </div>
        ...
        function display_package_benefits() {
         ...
         function discounts_pop_up() {
            ...
            function pop_up_additionals(){
                ...
                if(String(package_additionals_value) == "none"){
                  if(document.getElementById("additional_amount").value == 0){
                    ...
                    alert("Please reduce additional charge amount to 0.");
                    document.getElementById("additionals").value="others";
                  }
...
function cache_all_form_date(){
  ...
  if (typeof(Storage) !== "undefined") {
    ...
    localStorage.setItem("contactnumber", "<?php echo $customer_contactNum?>");
