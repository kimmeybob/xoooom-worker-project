      ...
      //Check if Product Order id is '0'  (Independent Product Purchase) /** SHOULD NOE BE DELETED! */  
        if($job_listing_id == "0" || $job_listing_id == 0){
          ...
          echo "Unbinded Product Purchase.";
           $sql_delete_unbinded_product_items = "DELETE FROM product_commissions WHERE product_commission_id = '$unbinded_commission_id'";
                            //$wax_status = "true";
                            if ($connection->query($sql_delete_unbinded_product_items) === TRUE) {
                                    

                                    $sql_delete_unbinded_product_items = "DELETE FROM product_item_orders WHERE product_commission_id = '$unbinded_commission_id'";
