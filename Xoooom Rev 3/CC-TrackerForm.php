...
<body>
    ...
    <div style=" display: block;background: black;top:0;left: 0; position:fixed;z-index: 10;width: 100%;height: 100%;margin: 0;opacity: 0.95;" id="loader_visuals" class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
        ...
        <div style="margin-top: 5%;margin-left: 5%;margin-right: 5%;background: white;">
            ...
            <div style="float: right; width: 15%;position: relative;display: inline-block;text-align: right;"><p style="width: auto;background: white;margin:0;margin-top: 10%;overflow: hidden">
                <a onclick="display_page_Loading()" href="CC-Service_Worker_Job_Listing_Que.php?job_id=<?php echo $job_listing_id;?>" style="color: black;font-size: 14px">Cancel</a></p></div><br>
    ...
    <div class="col-md-12">
      ...
      <div >
        ...
        <input onclick="display_page_Loading()" style="font-size: 14px;background: white;border:1px solid #0279F6;padding-bottom: 2.5%;padding-left: 2.5%;padding-right: 2.5%;padding-top: 2.5%;text-align: center;border-radius: 100px;color: #0279F6;font-weight: bold" type="submit" value="Add a Product Order (Disabled)" readonly></a>
        </form>
      </div>
      <br>
      <form action="Php_Function/add_commission_tracker.php?job_listing_id=<?php echo $job_listing_id;?>" onsubmit="return submission_check()" method="POST"> 
      ...
      ?>
        ...
        <input style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px;background: white;" class="form-control" type="text" value="<?php echo $job_order_date;?>" placeholder="mmmm" id="time_serviced" name="date_serviced" readonly>
        </div>
      </div>
