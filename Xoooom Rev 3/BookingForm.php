...
<body>
	...
	<form action="submitbooking" method="POST">
	  ...
	  <div class="form-group">
	    ...
	    <input style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px" class="form-control" type="tel" id="phone" name="phone" placeholder="63+" pattern=(\d{11})) required>
	  	</div>
	  </div>
 ...
 <label style="color: #868686;font-size: 12px;">Set Schedule</label><br/>
	  ...
	  <div class="form-group">
	  	...
	  	<div style="width: 100%;display: inline-block;border: 1px solid #D3D3D3;padding-bottom: 1%;padding-top: 1%;padding-right: 2%;padding-left: 2%;border-radius: 15px;">
	    <textarea style="border-radius: 10px;border-color: none; border-style: none;font-size: 14px" id="message" name="message" placeholder="Tell us anything that might be important." class="form-control" required></textarea>
	  </div>
	</div>
