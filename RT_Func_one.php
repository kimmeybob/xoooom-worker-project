<!-- Recycleable Layout Cards --->
        ...
        <div style="background: #2AA965;height: auto;border: 1px solid white;border-radius:10px 10px 0 0;padding: 4%;display: block;margin-top:0.5%;">
        <div style="margin-bottom: 10%;">
                            ...
                            <?php
                                  if($products_total == "NULL" || $products_total == null){
                                  }else{
                              ?>
