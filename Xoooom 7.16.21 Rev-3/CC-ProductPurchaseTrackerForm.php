  ...
  <!-- //Column Header Labels -->
    ...
    <div style="background: white;height: 100px;border: 1px solid #F0F0F0;padding: 3%;padding-bottom: 5%;">
      ...
      <div style="background: white;float: left;display: block;height: 100%;width:80%;display: inline-block;margin-left: 5%;">
          ...
          <span style="padding-left: 10%;padding-right: 10%;padding-top: 5%;padding-bottom: 5%;border-radius: 0px;font-weight: normal;background: #F0F0F0;border: 1px solid #F0F0F0;display: inline-block;"><span style="font-size: 12px;margin:0;color: white;"> <i class="fa fa-minus" aria-hidden="true" style="color: #A0A0A0;"></i></span></span>
          <span style="padding: 5%;font-weight: normal;background: #F0F0F0;display: inline-block;" id="wax_quantity_output">0</span>
          <span style="padding-left: 10%;padding-right: 10%;padding-top: 2.5%;padding-bottom: 2.5%;border-radius: 0px;font-weight: normal;background: #F0F0F0;border: 1px solid #F0F0F0;display: inline-block;"><span style="font-size: 12px;margin:0;color: white;"> <i class="fa fa-plus" aria-hidden="true" style="color: #A0A0A0;"></i></span></span>
    ...
    <div style="background: white;height: 100px;border: 1px solid #F0F0F0;padding: 3%;padding-bottom: 5%;">
      <div style="background: #FF3C49;float: left;display: inline-block;height: 100%;width:2%;">
          <!-- Insert Image here -->
      ...
      <div style="background: white;float: left;display: block;height: 100%;width:80%;display: inline-block;margin-left: 5%;">
          ...
          <span style="padding-left: 10%;padding-right: 10%;padding-top: 5%;padding-bottom: 5%;border-radius: 0px;font-weight: normal;background: #F0F0F0;border: 1px solid #F0F0F0;display: inline-block;"><span style="font-size: 12px;margin:0;color: white;"> <i class="fa fa-minus" aria-hidden="true" style="color: #A0A0A0;"></i></span></span>
          <span style="padding: 5%;font-weight: normal;background: #F0F0F0;display: inline-block;">0</span>
          <span style="padding-left: 10%;padding-right: 10%;padding-top: 2.5%;padding-bottom: 2.5%;border-radius: 0px;font-weight: normal;background: #F0F0F0;border: 1px solid #F0F0F0;display: inline-block;"><span style="font-size: 12px;margin:0;color: white;"> <i class="fa fa-plus" aria-hidden="true" style="color: #A0A0A0;"></i></span></span>
    ...
    <div style="background: white;height: 100px;border: 1px solid #F0F0F0;padding: 3%;padding-bottom: 5%;">
      <div style="background: #282828;float: left;display: inline-block;height: 100%;width:2%;">
          <!-- Insert Image here -->
    ...
    <div style="background: white;height: 100px;border: 1px solid #F0F0F0;padding: 3%;padding-bottom: 5%;">
      <div style="background: #F3BA1E;float: left;display: inline-block;height: 100%;width:2%;">
          <!-- Insert Image here -->
    ...
    <div style="background: white;height: 100px;border: 1px solid #F0F0F0;padding: 3%;padding-bottom: 5%;">
      <div style="background: #2AA965;float: left;display: inline-block;height: 100%;width:2%;">
          <!-- Insert Image here -->
